...
export default {
    ...
    mounted() {
        ...
        chart.exporting.menu.items[0].menu[2].hidden = true
        chart.exporting.menu.items[0].menu[0].menu[4].hidden = true
        chart.exporting.menu.items[0].menu[1].menu[2].hidden = true
