<template>
    <div>
        <v-layout d-flex wrap>
            ...
            <v-text-field hide-details outline class="resultElement" readonly id="max-pressure" label="Max pressure" :suffix="units.pressureUnit" v-model="performance.maxPressure"></v-text-field>
            <v-text-field hide-details outline class="resultElement" readonly id="average-pressure" label="Average pressure" :suffix="units.pressureUnit" v-model="performance.averagePressure"></v-text-field>
