<template>
    <v-col>
        ...
        <v-row class="pl-1 pr-1" d-flex wrap lg="12">
            <v-col lg="6" md="6" v-if="modelValue.grainType === hollowCode">
            ...
            <v-col lg="6" md="6" v-if="modelValue.grainType === finocylCode">
            ...
            <v-col lg="6" md="6" v-if="modelValue.grainType === starGrain">
            ...
            <v-col lg="12" md="12" v-if="modelValue.grainType === endBurnerGrain">
            ...
            <v-col lg="6" md="6" v-if="modelValue.grainType === moonBurner">
            ...
            <v-col lg="6" md="6" v-if="modelValue.grainType === cSlot">
            ...
            <v-col lg="6" md="6" v-if="modelValue.grainType === rodTube">
